...
- **Geral:** Dashboard, Meus documentos, Agentes de IA e Suporte, sujeitos às
  respectivas permissões e com conteúdo filtrado pelo departamento;
- **Cadastros:** Cadastro Principal e conciliação, conforme as permissões de
  clientes e histórico;
- **Comercial:** Painel WhatsApp, Contatos e Orçamentos, somente para vínculo
  Comercial;
...
- **Administração:** Painel administrativo exclusivo de administradores, além de
  Licença conforme as permissões e o vínculo organizacional. O painel
...
Este módulo documenta a integração local atual e não substitui o modelo
canônico de Viagem e Plano de Rota. A evolução depende de
[GAP-TRIP-01](tenant-api-contract-gaps.md). No contrato legado,
...
Contas de cliente legadas preservam `routingCompanyId` e departamento
`client-company`. Novas contas desse modo estão bloqueadas até a Área do Cliente
publicar representação e permissões próprias. Usuários internos permanecem no
tenant Milenium e podem operar vários clientes quando autorizados.
